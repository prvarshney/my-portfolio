...
export class Portfolio extends Component {
    render() {
        return (<div>
            ...
            <h2 style={{ color: "#000", fontWeight: "400" }} className="mt-5">MY PORTFOLIO</h2>
            ...
            <div className="row">
                <div className="col-11 mt-4" style={{ fontSize: "18px" }}>
                    ...
                    <div className="row">
                        ...
                        <div className="col-9 text-left pl-5">
                            ...
                            Are you Looking for a <span style={{ color: "#04b4e0" }}><strong>Software Development Engineer </strong></span> 
                    ...
                    <div className="row">
                        ...
                        <div className="col-5 text-left pb-4pt-4">
